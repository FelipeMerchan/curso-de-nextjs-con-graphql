...
import { Avocado, GetAllAvocadosDocument, GetAvocadoDocument } from '@service/graphql';
...
export const getStaticPaths: GetStaticPaths = async () => {
  ...
  return {
    paths,
    // Pre-renderice las páginas anteriores y para toda nueva página
    // intente generarla desde el servidor bajo demanda
    fallback: 'blocking',
  }
}

export const getStaticProps: GetStaticProps<{ product: Avocado }> = async ({ params }) => {
  try {
